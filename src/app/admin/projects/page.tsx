    ...
    <div className="space-y-5">
      <section className="soft-panel p-4">
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="text-xs tracking-[0.2em] text-muted-foreground uppercase">Projects</p>
            <h2 className="title-cinematic mt-1 text-2xl font-semibold">Wedding List</h2>
          </div>
          <Link href="/admin/projects/new" className="h-10 rounded-xl border border-foreground bg-foreground px-4 py-2 text-sm text-background">
            Add wedding
          </Link>
        </div>
      </section>
